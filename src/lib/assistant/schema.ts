...
export const SCHEMA_TEXT = [
  ...
  "분반(groupKey)과 이름 — 디지털 마음 톡톡: mt-tue-1(화요일 1기)·mt-thu-1(목요일 1기)·mt-tue-2(화요일 2기)·mt-thu-2(목요일 2기). 인간과 인공지능: hai-tue-1(화요일 1기)·hai-thu-1(목요일 1기)·hai-tue-2(화요일 2기)·hai-thu-2(목요일 2기).",
  "분반 전체의 감정으로 '눈여겨볼 학생' 을 물으면 queryData 로 하나씩 돌지 말고 classEmotions 에 group 을(열쇠 'mt-thu-1' 또는 이름 '목요일 1기') 넘겨 한 번 부른다. 분반 이름만 있으면 위 표로 열쇠를 고른다.",
