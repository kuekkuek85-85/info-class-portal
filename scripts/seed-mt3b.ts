/**
 * 「디지털 마음 톡톡」(자유학기 주제선택) 3회기 — 감정 조절하기: 감정 지도·힐링.
 *
 *   node --env-file=.env.local scripts/seed-mt3b.ts
 *
 * ## 인식에서 조절로 넘어간다
 *
 * 앞 회기까지가 자기 영역의 **감정 인식하기** 였다. 낱말로 구별하고, 글로 적고,
 * AI 추측과 견줘 보며 "정답은 나에게 있다" 까지 갔다. 이번 회기는 **감정 조절하기** 다 —
 * 알아차린 다음에 무엇을 하느냐. (차시 번호 204·활동통 mt-2026-2 는 이미 수업한
 * 기록이라 그대로 둔다. 바꾸는 것은 회기 라벨과 대기 게임뿐이다.)
 *
...
const PLAN: Omit<LessonPlan, "id" | "createdAt" | "updatedAt"> = {
  lessonNo: LESSON_NO,
  title: "디지털 마음 톡톡 3회기 — 감정 조절하기: 감정 지도·힐링",
