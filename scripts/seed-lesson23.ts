...
const SEEDS: PlanSeed[] = [
  {
    ...
    /*
     * 두 번째 질문은 **다음 시간 그리기의 밑그림**이다.
     *
     * 4반에서 해 보니 30분 안에 퀴즈·영상까지 하고 그리기까지 끝내는 것이 무리였다.
     * 그래서 그리기를 3차시로 넘기고, 대신 여기서 "어디에 무엇을" 을 글로 정해 두게 한다.
     * 빈 캔버스 앞에서 무엇을 그릴지 고민하는 5분이 3차시에서 통째로 사라진다.
     *
     * 장소 예시를 질문 안에 적어 둔 이유: 그리기 화면을 아직 못 봤으니 어떤 선택지가
     * 있는지 알 수 없다.
     */
    reflectionQuestions: [
      "타임머신 퀴즈에서 1996년과 지금을 비교했어요. 가장 놀랐던 변화 하나를 고르고, 왜 놀랐는지 써 주세요.",
      "다음 시간에 2040년의 한 장소를 그립니다. 어디를 그릴지 정하고, 그곳에 어떤 기술을 넣고 싶은지 · 그 기술이 무엇을 해 주는지 적어 주세요.\n(음식점 · 학교 · 병원 · 집 · 도로 · 편의점 · 놀이공원 · 경기장 · 농장 · 미용실 — 다른 곳을 정해도 좋아요)",
    ],
