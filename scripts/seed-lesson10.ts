 ...
 * ## 자가진단은 자동 합산하지 않는다
 *
 * 활동지 엔진에는 채점 로직이 없고, 이 척도는 8·10·13번이 **역채점** 문항이라(조절할 수
 * 있다·불안하지 않다·방해가 되지 않는다 — 건강한 쪽이 "매우 그렇다") 단순 합산이 애초에
 * 틀린다. 그래서 15문항을 학생이 스스로 표시하게만 하고(각 답은 개인용으로 저장), 채점은
 * 안내 문항으로 역채점을 정확히 설명해 학생이 스스로 구간을 확인하게 둔다.
 *
...
const WORKSHEET: WorksheetQuestion[] = [
  ...
  },
  {
    ...
    hint:
      ...
      "→ 홍길동은 어떻게 대처해야 할까요? 자신의 의견을 써 봅시다.",
    kind: "long",
    maxLength: 1000,
  },
  {
