...
async function main(): Promise<void> {
  ...
  console.log("");
  console.log("40분에 15분짜리 두 덩어리 중 하나만 들어갑니다 — 골라서 쓰세요.");
  console.log("  ⓐ 사례 사냥만  — 기분 3 · 예고 6 · 채점 기준 12 · 사례 사냥 15 · 성찰 3 = 39분");
  console.log("     (캔바 단계를 안 누르면 됩니다. 수행평가 준비로는 이쪽이 낫습니다)");
  console.log("  ⓑ 캔바만      — 기분 3 · 예고 6 · 캔바 15 · 채점 기준 12 · 성찰 3 = 39분");
  console.log("     (사례 사냥은 숙제로 돌리세요. 캔바는 리포트 ② 때 써도 됩니다)");
