 ...
 * **내 직업이 일하는 미래 한 장면을 그리는 것**과, **채점 기준을 직접 채점해 보는 것**.
 *
 * ## 그림은 채점하지 않는다
 *
    ...
    tabs: [
      {
        ...
        highlights: [
          "오늘은 리포트를 쓰지 않습니다. 그림을 그리고 채점 기준을 익히는 시간이에요.",
  ...
  activity: {
    ...
    drawPrompt: {
      ...
      body:
        ...
        "그 자리에 인공지능·로봇이 함께 있는 모습으로 그려 주세요.\n" +
...
async function main(): Promise<void> {
  ...
  console.log("단계: 대기 → 기분 → 수행평가 예고 → 내 직업의 미래 그리기 → 채점 기준 익히기 → 성찰 → 마침");
  console.log("오늘은 리포트를 쓰지 않습니다. 채점 기준을 익히고, 다음 시간에 쓸 사례를 찾아 둡니다.");
  console.log("40분 배분 — 기분 3 · 예고 6 · 그리기 12 · 채점 기준+사례 15 · 성찰 3 = 39분");
