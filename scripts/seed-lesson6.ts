 ...
 * 점수가 되기 때문이다.
 *
 * 그렇다고 40분을 안내로만 쓸 수는 없다. 그래서 이 시간의 본체는 **채점 기준을 직접
 * 채점해 보는 것**과, 다음 시간에 쓸 **사례를 찾아 두는 것**이다.
 *
...
const WORKSHEET: WorksheetQuestion[] = [
  ...
  },
  {
    ...
    hint:
      ...
      "예) 우리 동네 분식집. 원래는 사장님이 주문을 받고 음식을 날랐는데,\n" +
...
async function main(): Promise<void> {
  ...
  console.log("단계: 대기 → 기분 → 수행평가 예고 → 채점 기준 익히기 · 사례 사냥 → 성찰 → 마침");
  console.log("오늘은 리포트를 쓰지 않습니다. 채점 기준을 익히고, 다음 시간에 쓸 사례를 찾아 둡니다.");
  console.log("40분 배분 — 기분 3 · 예고 6 · 채점 기준 12 · 사례 사냥 15 · 성찰 3 = 39분");
  console.log("캔바는 리포트 ②(디지털 약속 카드뉴스) 때 씁니다. 이 차시에는 없습니다.");
  process.exit(0);
}
