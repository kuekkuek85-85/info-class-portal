...
const WORKSHEET: WorksheetQuestion[] = [
  ...
  },
  {
    ...
    hint:
      ...
      "오늘의 목표는 '발표 준비' 예요 — 앱을 새로 만들거나 크게 고치는 시간이 아니에요.\n" +
      "피드백은 참고만 하고, 지금 바로 손볼 수 있는 것만 가볍게 반영하세요. 오늘은 발표 자료\n" +
      "(슬라이드) 만들기에 집중하면 됩니다. 오늘 반영하지 못한 피드백은, 발표에서 '앞으로 개선할\n" +
      "점' 으로 이야기하면 돼요.",
    kind: "note",
    maxLength: 0,
  },
  ...
  },
  {
    ...
    hint:
      ...
      "(오늘은 새로 검토하거나 크게 고치는 시간이 아니에요 — 받은 피드백을 참고해 발표를 준비합니다.)",
    kind: "note",
    maxLength: 0,
  },
  {
  ...
  },
  {
     ...
     */
    label: "③ 피드백 반영·개선점 — 반영한 것, 또는 앞으로 개선할 점",
    hint:
      "오늘은 발표 자료를 만드는 게 목표라, 앱을 크게 고치지 않아도 돼요.\n" +
      "세 피드백(AI·선생님·친구) 중 지금 바로 손볼 수 있는 게 있으면 가볍게 반영하고,\n" +
