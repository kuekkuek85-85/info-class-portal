...
const WORKSHEET: WorksheetQuestion[] = [
  // ── 뽑기 완주 (4~24분) ────────────────────────────────
  {
     ...
     * 지난 시간에 쓴 것을 맨 위에 편다.
     *
     * 일주일이 지났고, 중1은 자기가 무엇을 만들려 했는지 기억하지 못한다. 기억을
     * 되살리는 데 5분을 쓰면 뽑기 시간이 그만큼 사라진다. 활동 ID 가 같아서
     * 따로 실어 나르지 않아도 여기 그대로 있다.
     */
  ...
  },
  {
    ...
    hint:
      ...
      "비밀번호는 학교 계정 비밀번호예요.\n" +
      "여기서 막히면 바로 손을 드세요. 로그인은 혼자 붙잡고 있어도 안 풀립니다.",
    kind: "note",
...
const PLAN: Omit<LessonPlan, "id" | "createdAt" | "updatedAt"> = {
  ...
  progress: {
    ...
    body:
      ...
      "캔바에서 만드는 데까지가 생각보다 오래 걸렸어요. 그래서 오늘은 거기부터 합니다.\n\n" +
