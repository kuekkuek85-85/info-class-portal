...
const WORKSHEET: WorksheetQuestion[] = [
   ...
   */
  {
    key: "de11_cope",
    phase: "worksheet",
    label: "② 대처방안 — 이미 벌어진 이 일에 지금 어떻게 대응할까 (사후, 2개 이상)",
    hint:
      "대처는 '이미 벌어진 일'에 지금 대응하는 것이에요(사후). 상황 속 '나'가 지금 할 수 있는\n" +
      "대처를 한 칸에 하나씩, 2개 이상 적으세요. 칸이 모자라면 「+ 칸 추가」를 누르면 됩니다.\n" +
      "(앞으로 이런 일이 안 생기게 미리 막는 것은 대처가 아니라 아래 ③ 예방에 씁니다.)\n" +
   ...
   */
  {
    ...
    phase: "worksheet",
    label: "③-1 예방방법 · 나 혼자 (사전)",
    hint:
      "예방은 '일이 벌어지기 전에' 미리 막는 것이에요(사전 — 위 ② 대처는 벌어진 뒤 대응이었죠).\n" +
  ...
  },
  {
    ...
    phase: "worksheet",
    label: "③-2 예방방법 · 우리 반이나 사회 (단체, 국가 등) (사전)",
    hint:
      "이것도 '미리 막는' 예방이에요(사전). 우리 반이나 사회(단체, 국가 등)가 함께 실천할\n" +
      "예방방법을 쓰고, 왜 그것이 예방이 되는지 근거도 붙이세요.\n" +
   ...
   */
  {
    ...
    reviewPersona: {
      ...
      subject:
        "학생이 고른 디지털 윤리 위반 사례와, 그에 대한 학생의 원인·피해 분석과 대처·예방 의견. " +
        "학생이 대처(이미 벌어진 일에 대응 = 사후)와 예방(일이 벌어지기 전에 막기 = 사전)을 헷갈려 " +
        "쓴 곳이 있으면 그것을 알아채도록 되묻는다",
    },
    /* Gemini 가 죽어도 논술 맥락에 맞는 질문이 나가게 한다(기본 폴백은 앱 기획용이라 안 맞음) */
    reviewFallback: [
      "네가 ‘대처’에 쓴 것이 사실은 미리 막는 ‘예방’ 아닐까? (대처=이미 벌어진 뒤 대응, 예방=벌어지기 전에 막기) 헷갈린 곳은 없을까?",
   ...
   */
  {
    ...
    label: "⑤ 마무리 성찰 — 내 이야기로",
    hint:
      "오늘 고른 것과 비슷한 일을, 나 또는 내 친구가 실제로 겪거나 본 적이 있나요? 있다면 어떤 " +
      "일이었는지, 그때 어떻게 했는지(또는 어떻게 하면 좋았을지) 적어 보세요.\n" +
      "겪은 적이 없다면, 오늘부터 내가 실천할 예방·대처 한 가지를 적어도 좋아요.\n" +
      "※ 이 글은 선생님만 봅니다.",
    kind: "long",
    maxLength: ESSAY_MAX,
    noPaste: true,
