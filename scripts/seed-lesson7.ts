 ...
 * ## AI 는 정량적인 것만 본다
 *
 * 빠진 조건·글자 수·오탈자까지다. ②의 '왜' 가 설득되는지, ③이 ①②와 이어지는지는
 ...
 * 이름표 보강이다.
 *
 * ③ 취재는 **한 건만, 한 줄로** 줄였다. 검색이 길어지면 1차 제출이 25분에 몰려 루프가
 * 한 바퀴도 안 돈다. 막힌 학생을 위해 예시를 hint 에 박아 둔다.
 */
...
const WORKSHEET: WorksheetQuestion[] = [
   ...
   */
  {
    ...
    hint:
      ...
      "찾은 것을 그대로 베끼지 말고 내 말로 한 줄 바꿔 쓰세요.\n" +
      "찾은 곳은 아래 「출처」 칸에 적어 주세요.",
    kind: "long",
    maxLength: 300,
  },
...

  {
    ...
    maxLength: 0,
    /*
     * 최소 글자 수는 "이만큼은 써야 기사다" 가 아니라 **"이보다 짧으면 아직 안 쓴 것"**
     * 의 선이다. 넉넉히 잡으면 다 쓴 학생을 붙잡고, 빡빡하게 잡으면 한 줄만 쓰고 넘어간다.
     */
    submitFields: [
